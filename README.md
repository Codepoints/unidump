...
* Finally learn what your favorite Emoji is composed of:
  ...
  See <http://emojipedia.org/man-elf-medium-skin-tone/>. The “elf” emoji is
  replaced with a dot, because the current version of Python’s unicodedata
  doesn’t know of this character yet.

* Use it like strings(1):

      unidump -e '{data}' some-file.bin

  This will replace all unknown bytes from the input file with “X” and all
  control and whitespace characters with “.”.
